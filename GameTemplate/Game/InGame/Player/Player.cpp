...
namespace
{
	...
	const int     TIMERAINDELETE      = 295;                   //雨のエフェクトが消える時間
	//////////////////////////////////////
...
void Player::InitAnimation()
{
	...
	m_animClips[enAnimationClip_Goal2].SetLoopFlag(false);
...
void Player::TimeLimit()
{
	...
	//制限時間が295秒以下なら雨のエフェクトを消す。
	else if (Game_Timer <= TIMERAINDELETE)
	{
		m_game->Rain = false;
		//文字をグレーにする。
