...
#include "InGame/Bg/Ground.h"
#include "InGame/Bg/Tree.h"
#include "InGame/Bg/Fence.h"
#include "InGame/Bg/FenceHalf.h"
#include "InGame/Bg/Stairs.h"
#include "InGame/Gimmick/Block.h"
#include "InGame/Bg/FlowerBed.h"
#include "InGame/Bg/WoodenBox.h"
#include "InGame/Bg/Grass.h"
#include "InGame/Bg/Flower.h"
#include "InGame/Bg/Shrub.h"
#include "InGame/Bg/Pebble.h"
#include "InGame/Bg/Puddle.h"
#include "InGame/Bg/Signboard.h"
#include "InGame/Bg/Wood_Road.h"
#include "InGame/Bg/Windmill.h"
#include "InGame/Bg/Pipe.h"
#include "InGame/Bg/Rock_Big.h"
#include "InGame/Gimmick/GroundMove.h"
#include "InGame/Bg/GroundRoad.h"
#include "InGame/Gimmick/Fort.h"
#include "InGame/Gimmick/FortTop.h"
#include "InGame/Bg/Ring.h"
#include "InGame/Bg/Bard.h"
#include "InGame/Enemy/Enemy_Green.h"
#include "InGame/Enemy/Enemy_Red.h"
#include "InGame/Enemy/Enemy_Yellow.h"
#include "InGame/Bg/GoalPoint.h"
#include "InGame/Camera/GameCamera.h"
#include "InGame/Bg/HitBox.h"
#include "InGame/Camera/Default.h"
#include "InGame/Camera/Forward.h"
#include "SkyCube.h"
...
namespace App {
	...
	Game::~Game()
	{
		...
		const auto& puddles = FindGOs<Puddle>("puddle");
	...
	bool Game::Start()
	{
		...
		m_levelRender.Init("Assets/level3D/level1.tkl",
			[&](LevelObjectData& objData) {
				...
				//名前がpuddleだったら
				else if (objData.EqualObjectName(L"puddle") == true) {
					//小石のオブジェクトを作成する。
					Puddle* puddle = NewGO<Puddle>(0, "puddle");
					//座標を設定する。
					puddle->SetPosition(objData.position);
					//大きさを設定する。
					puddle->SetScale(objData.scale);
					//回転を設定する。
					puddle->SetRotation(objData.rotation);
					return true;
				}
				//名前がrock_bigだったら
